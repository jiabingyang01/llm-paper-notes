...
- [DUST (2026)](papers/06-embodied-ai/vla/reasoning/DUST_2026.md) — MMDiT 双流（动作流+视觉流仅在跨模态注意力层交互）+ 每模态独立加噪的解耦流匹配 + 异步采样推理缩放，世界模型增强 VLA，超 FLARE 5-6%、真实 Franka +10%，ICML 2026
