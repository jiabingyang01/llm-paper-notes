...
| 类型 | 建模空间 | 代表方法 | 优劣 |
| --- | --- | --- | --- |
| **状态级** | 隐空间 | Dreamer | 计算高效，但丢失视觉细节 |
| **观测级** | 像素空间 | iVideoGPT, GWM, EmbodiedDreamer, WMPO | 保留视觉保真度，但计算昂贵 |
...
- **WMPO**：像素级视频扩散（OpenSora + SDXL VAE）+ Policy Behavior Alignment + on-policy GRPO
