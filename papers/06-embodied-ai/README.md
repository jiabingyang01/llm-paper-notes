...
| [LDA-1B](world-models/LDA_1B_2026.md) | 统一世界模型基础模型（策略+正逆动力学+视觉预测）、通用数据摄入（质量分层监督）、结构化 DINO 潜在预测、MM-DiT、EI-30k、RoboCasa-GR1 55.4% 超 3B GR00T、真机 +21%/48%/23%、RSS 2026 | 2026 |
...
| [SpatialVAM](world-models/SpatialVAM_2026.md) | 3D Video Action Model、多视图正交投影 RGB + 热力图、Wan2.2-5B + View-Attention LoRA、双扩散损失、Meta-World 89.1%、RoboCasa 42%、真实 Franka 57.1%、单步去噪 85.7% | 2026 |
| [WAM Survey](world-models/WAM_Survey_2026.md) | 首篇 World Action Models 系统综述、定义 WAM 与相邻概念划界、Cascaded/Joint 架构分类、四类数据生态、三维评估协议（视觉保真/物理常识/动作可行性）、七大开放挑战 | 2026 |
