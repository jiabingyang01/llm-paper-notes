...
| [Qwen-RobotManip](/papers/06-embodied-ai/vla/foundation/Qwen_RobotManip_2026) | Qwen3.5-4B VLA 基础模型，主张"先对齐再规模化"：统一 80 维状态-动作表征 + 相机系相对位姿 + in-context 行为适配三层对齐，人到机器人合成把 1933h 人类视频渲染成跨 15 平台 24808h 机器人数据，纯开源语料 ~38100h，OOD 全面超 π₀.₅、RoboChallenge Table30-v1 generalist 第一 | 机器人操作基础模型、跨本体对齐、人到机器人合成、camera-frame delta pose、OOD 评测、DiT flow matching | 2026.06 |
...
| [DUST](/papers/06-embodied-ai/vla/reasoning/DUST_2026) | MMDiT 双流（动作流+视觉流仅在共享跨模态注意力层交互）+ 每模态独立加噪的解耦流匹配（学正/逆双向因果）+ 异步采样（视觉 token 比动作多去噪几步，推理时缩放），GR00T-N1.5 上 RoboCasa/GR-1 超 FLARE 5%/6%、真实 Franka +10%，支持无动作视频预训练与人机异构联合训练（ICML 2026） | 世界模型增强 VLA、双流扩散、MMDiT、解耦噪声、异步采样 | 2025.10 |
| [FLARE](/papers/06-embodied-ai/vla/reasoning/FLARE_2025) | 给流匹配 DiT 加 M 个可学习未来 token，中间层激活与未来观测的动作感知潜在嵌入做 cos 对齐（λ=0.2），隐式世界建模无需重建未来帧；RoboCasa 70.1%/GR1 55.0% 超 UWM，真实 GR1 95.1%，解锁无动作人类视频协同训练（1 条机器人轨迹达 60%） | 隐式世界模型、未来潜在对齐、动作感知嵌入、Q-former、人类视频协同 | 2025.05 |
